...
export default function FAQ() {
  ...
  return (
    <div className="flex flex-col">
      <div className="top-0 w-full h-full bg-gray-900 text-white">
        {/* Content */}
        <div className="flex justify-center items-center py-32">
          <div className="text-center">
            <h1 className="h-24 w-56 text-6xl border-purple-500 border-2 font-bold pb-10">
              FAQ
            </h1>
          </div>
        </div>
      ...
      <div className="bg-gray-100 h-screen w-full">
        <h1 className="absolute left-0 mt-10 ml-10 underline-text border-purple-500 border-2 text-3xl text-black font-bold leading-none">
        ...
        <div className="flex flex-col align-left pl-10 pr-10 mx-auto pt-24 bg-gray-200 pb-10">
          ...
          <QuestionCard
            ...
            imgUrl={
              <VerifiedUserIcon style={{ fill: 'black', fontSize: 55 }} />
            }
          />
        </div>
        <div className="absolute w-full h-screen bg-gray-900">
          <div className="flex flex-col lg:flex-row">
            <h1 className="absolute left-0 mt-10 ml-10 underline-text border-purple-500 border-2 text-3xl text-white font-bold leading-none">
              Envianos un correo.
            </h1>
                  ...
                  <div className="text-white">
                    ...
                    <div className="w-full md:w-1/2 py-3 px-2 mb-6 md:mb-0">
                      ...
                      <textarea
                        ...
                        className="appearance-none block w-full h-64 bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white"
