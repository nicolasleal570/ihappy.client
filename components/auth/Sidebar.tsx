        ...
        <div className="flex">
            <div className="w-1/5 bg-purple-700 h-screen">
                <div className="flex-col pt-10 bg-purple-700">
                    ...
                    <h1 className="font-bold capitalize text-xl text-center text-white pb-4">John Doe</h1>
                    ...
                    <h2 className="font-semibold capitalize text-l text-center text-white py-4">Make an Appoinment</h2>
            ...
            <div className="w-4/5 bg-white ml-5 h-screen">
