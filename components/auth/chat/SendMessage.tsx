...
const SendMessage = ({selectedChatId,userId,updateMessage}: SendMessageProps) => {
  ...
  return (
    ...
    <div className="border-l border-t border-gray-300 px-6 py-4 w-full flex">
      ...
      <svg width="21" height="21" viewBox="0 0 21 21" className="fill-current text-white" xmlns="http://www.w3.org/2000/svg">
